    ...
    <div>
      ...
      {selectedReport && (
        <div className="modal-backdrop" onClick={() => setSelectedReport(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ padding: '32px', maxWidth: '700px' }}>
            ...
            <div style={{ background: 'rgba(7, 15, 30, 0.9)', padding: '14px', borderRadius: '8px', border: '1px solid var(--border-color)', marginBottom: '20px' }}>
            ...
            <form onSubmit={handleSubmitFeedback}>
              <div style={{ marginBottom: '16px' }}>
                <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '8px' }}>
                  Select Validated SIF Potential Label:
                </label>
                <div style={{ display: 'flex', gap: '12px' }}>
                  ...
                  <button
                    ...
                    style={{ flex: 1, justifyContent: 'center', background: reviewLabel === 'UNCERTAIN' ? 'var(--accent-uncertain-amber)' : undefined }}
                  >
                    UNCERTAIN
                  </button>
                </div>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '8px 12px', borderRadius: '8px', border: '1px solid var(--border-color)', background: 'rgba(7, 15, 30, 0.8)', color: 'var(--text-primary)', fontSize: '0.85rem' }}
                />
              </div>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <textarea
                  ...
                  style={{ width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid var(--border-color)', background: 'rgba(7, 15, 30, 0.8)', color: 'var(--text-primary)', fontSize: '0.85rem', fontFamily: 'var(--font-main)' }}
                />
              </div>
